...
<head>
    ...
    <link rel="icon" href="images/layui/favicon.ico">
    <link rel="stylesheet" href="js/layui/layui-v2.6.3/css/layui.css" media="all">
    <link rel="stylesheet" href="css/layui/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="css/layui/themes/default.css" media="all">
    <link rel="stylesheet" href="js/layui/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
...
<script src="js/layui.js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
